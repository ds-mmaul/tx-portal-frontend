...
- IdP Management
  ...
  - Network Registration Moch UI - fixed extId input field pattern to allow 6-36 alphanumeric characters
...
- Company Certificate Delete function missing backend API connected
- Semantic Models - overlay diagram can not get displayed due to semantic model backend external dependency error - function temporarily deactivated
...
- Own IdP Config Flow - incorrect text values and user email display on the last overlay screen (confirmation screen of own user id connected and suggestion of running a test login)
- Broken chip card element
 - App User View - Not showing assigned roles
 - App Release Process - selected usecases not displayed
 - App Change Process 'Change App Role(s)' - roles not showing
- App Subscription Request Configuration Overlay - *Help* hyperlink incorrectly configured
...
- App Release Process - entering a useCase value in the input field results into blank/white page
